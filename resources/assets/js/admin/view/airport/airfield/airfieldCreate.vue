<template>
    <div>
        <div class="card card-border-color card-border-color-primary">
            <div class="card-header card-header-divider">Airfield Type</div>
            <div class="card-body">
                <form @submit.prevent="postAirfield">
                    <div class="controls">
                        <div class="row">
                            <div class="col-md-12">
        ...
        methods: {
            ...
            postAirfield(val) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        axios.post('/admin/airport/airfield', {
                            name:this.name,
                            ...
                            val==='redirect'?this.$router.push({path:'/admin/airport/airfield'}):''
            ...
            saveAndClose(){
                let val='redirect';
                this.postAirfield(val)
            },
            cancel(){
                this.$router.push({path:'/admin/airport/airfield'})
            },
        }
    }
</script>
