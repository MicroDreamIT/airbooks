<template>
    <div>
        <div class="card card-border-color card-border-color-primary">
            <div class="card-header card-header-divider">Part Release</div>
            <div class="card-body">
        ...
        methods:{
            ...
            postRelease(val){
                this.$validator.validateAll().then((result)=>{
                    if (result){
                        axios.post('/admin/parts/release',{
                            name:this.name,
                            ...
                            val==='redirect'?this.$router.push({path:'/admin/parts/release'}):''
            ...
            saveAndClose(){
                let val='redirect';
                this.postRelease(val)
            },
            cancel(){
                this.$router.push({path:'/admin/parts/release'})
            }
        }
    }
</script>
