                ...
                <div class="aside_bar" >
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminEventCategoryCreate'}" v-if=" $root.$data.createPermission">
                            +Add
                        </router-link>
                ...
                <div class="listContent" ref="listHeight" :style="" v-if="categories.length">
                    <ul class="list-group">
                        <router-link v-for="category in categories"
                                     ...
                                     :to="{name:'adminEventCategoryShow', params:{id:category.id}}"
            ...
            <div slot="asideMainContent">
                <div v-if="category.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        ...
                        <div v-if="category.id">
                            <router-link :to="{name:'adminEventCategoryEdit', params:{id:category.id}}">
