<template>
    <div class="card card-table">
        <data-table
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminEngineCategoryCreate'"
                :tableHeadline="'Engine Categories'"
                :searchField="'name'"
                :modelName="'category'"
                :typeName="'engine'"
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminEngineCategoryShow', params:{id:props.data.id}}">
                        {{props.data.name}}
                    </router-link>
                </td>
                <td>
                ...
                <td>
                    <div class="adjustAction">
                        <router-link :to="{name:'adminEngineCategoryEdit', params:{id:props.data.id}}" v-if="$root.$data.editPermission">
