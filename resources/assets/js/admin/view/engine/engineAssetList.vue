<template>
    <div class="card card-table">
        <data-table-join
                ...
                :columns="columns"
                :addButton="false"
                :tableHeadline="'Engine Assets'"
                :searchField="'engines.title,engines.esn'"
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminEngineShow', params:{id:props.data.id+'-'+props.data.title}}">
        ...
        data() {
            return {
                ...
                columns: [
                    {name: 'Title'},
                    {name: 'ESN'},
                    {name: 'Status', nested:'engines.isActiveStatus'},
                    {name:'Action'}
                ]
            }
        },
            ...
            changeActiveStatus(id, status){
                ...
                if(status=='Revise'){
                    swal({
                        ...
                        preConfirm: (login) => {
                            return  axios.patch('/admin/engine/single-update/'+id+'/isActiveStatus/edit', {value:login})
                                .then(response => {
                    ...
                    axios.patch('/admin/engine/single-update/'+id+'/isActiveStatus/edit', {value:status})
                        .then(res=>{
