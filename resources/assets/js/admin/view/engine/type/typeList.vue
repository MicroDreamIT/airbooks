<template>
    <div class="card card-table">
        <data-table-join
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminEngineTypeCreate'"
                :tableHeadline="'Engine Types'"
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminEngineTypeShow', params:{id:props.data.id}}">
                        {{props.data.name}}
                    </router-link>
                </td>
                <td>
                ...
                <td>
                    <div class="adjustAction">
                        <router-link :to="{name:'adminEngineTypeEdit', params:{id:props.data.id}}"v-if="$root.$data.editPermission">
