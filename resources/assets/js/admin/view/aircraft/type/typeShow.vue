                ...
                <div class=" aside_bar">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminAircraftTypeCreate'}" v-if=" $root.$data.createPermission">
                            +Add
                        </router-link>
                ...
                <div class="listContent"  v-if="typeList.length">
                    <ul class="list-group">
                        ...
                        <router-link v-for="type in typeList"
                                     ...
                                     :to="{name:'adminAircraftTypeShow', params:{id:type.id}}"
            ...
            <div slot="asideMainContent">
                <div v-if="typeData.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        ...
                        <div v-if="typeData.id">
                            <router-link :to="{name:'adminAircraftTypeEdit', params:{id:typeData.id}}">
