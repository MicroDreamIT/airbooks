<template>
    <div>
        <div class="card card-border-color card-border-color-primary">
            ...
            <div class="card-body">
                <form @submit.prevent="updateWanted()">
                    <div class="">
                            ...
                            <div class="col-md-4 ">
                                <div class="form-group">
                                    ...
                                    <date-picker
                                            ...
                                            v-validate="'required'"
                                            name="yom"
                                            :class="{'is-danger': errors.has('wanted.yom') }"
                                    >
                                    </date-picker>
                                    <div v-show="errors.has('wanted.yom')" class="help is-danger">
                                        {{ errors.first('wanted.yom') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <!--<section class="dynamic-field">-->
                                    ...
                                    <!--<div class="col-md-12 d-flex flex-wrap justify-content-start mt-3 mb-3 pl-0 pr-0">-->
                                        <!--<div v-for="(form, index) in wanted.custom" v-if="wanted.custom.length" class="  form-inline customFormItem ml-0 mr-4  p-0">-->
                                            ...
                                            <!--<button  class="btn deleteBtn" @click.prevent="deleteForm(index)"><i class="icon mdi mdi-close"></i></button>-->
                                        <!--</div>-->
                                    <!--</div>-->
...
<script src="./js/wantedEdit.js"></script>
