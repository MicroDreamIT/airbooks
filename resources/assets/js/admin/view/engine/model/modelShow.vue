                ...
                <div class=" aside_bar">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminEngineModelCreate'}" v-if=" $root.$data.createPermission">
                            +Add
                        </router-link>
                ...
                <div class="listContent" ref="listHeight" :style=""  v-if="models.length">
                    <ul class="list-group">
                        <router-link v-for="model in models"
                                     ...
                                     :to="{name:'adminEngineModelShow', params:{id:model.id}}"
            ...
            <div slot="asideMainContent">
                <div v-if="model.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        ...
                        <div v-if="model.id">
                            <router-link :to="{name:'adminEngineModelEdit', params:{id:model.id}}">
