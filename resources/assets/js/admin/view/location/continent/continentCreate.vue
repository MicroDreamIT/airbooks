<template>
    <div>
        <div class="card card-border-color card-border-color-primary">
            <div class="card-header card-header-divider">Continent</div>
            <div class="card-body">
                <form @submit.prevent="postContinent">
                    <div class="controls">
                        <div class="row">
                            <div class="col-md-12">
        ...
        methods: {
            ...
            postContinent(val) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        axios.post('/admin/location/continent', {
                            name:this.name,
                            ...
                            val==='redirect'?this.$router.push({path:'/admin/location/continent'}):''
                        }).catch(error => {
                            let err
            ...
            saveAndClose(){
                let val='redirect';
                this.postContinent(val)
            },
            cancel(){
                this.$router.push({path:'/admin/location/continent'})
            }
        }
    }
</script>
