    ...
    <div>
        ...
        <admin-aside>
            ...
            <div slot="asideContent">
                <div class="aside_bar" >
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <!--<a href="#" class="dropdown-item" @click="sortKey = 'name', sortOrder=sortOrder=='asc'?'asc':'dsc'">name</a>-->
                        </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminEngineCategoryCreate'}" v-if=" $root.$data.createPermission">
                            +Add
                        </router-link>
                ...
                <div class="listContent" ref="listHeight" :style="" v-if="categories.length">
                    <ul class="list-group">

                        <router-link v-for="category in categories"
                                     class="list-group-item" :key="category.id"
                                     :to="{name:'adminEngineCategoryShow', params:{id:category.id}}"
                                     @click.native="show(category.id)"
                                     tag="li"
                                     style="cursor:pointer"
                        >
                            {{category.name|asideTitlify}}
                        </router-link>
            ...
            <div slot="asideMainContent">
                <div v-if="category.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        ...
                        <div v-if="category.id">
                            <router-link :to="{name:'adminEngineCategoryEdit', params:{id:category.id}}">
                                <i class="mdi mdi-edit"></i>
                            </router-link>
                            <a href="" class="pl-2 default-color"  @click.prevent="deleteMe(category.id)">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="cat_desc" v-if="category.name">
                                            <span>Name  </span> <br>
                                            <strong> {{category.name}}</strong>
                                        </p>
                                        
                                        <p class="cat_desc" v-if="category.description">
                                            <span>Description  </span> <br>
                                            <strong>  {{category.description}}</strong>
                                        </p>
                                        <p class="cat_desc" v-if="category.created_at">
                                            <span>Date Created </span> <br>
                                            <strong>{{$root.parseDate(category.created_at)}}</strong>
                                        </p>
                                        <p class="cat_desc" v-if="category.updated_at">
                                            <span>Date Modified </span> <br>
                                            <strong>{{$root.parseDate(category.updated_at)}}</strong>
                                        </p>
                                        ...
                                        <div class="cat_desc">
                                            ...
                                            <div class="switch-button switch-button-success switch-button-xs activeSwitch" >
                                                <input
                                                        ...
                                                        name="swt1"
                                                        :id="category.id"
                                                        @click.prevent="$root.changeIsBooleanStatus(category, 'is_active', 'App-Category')"
                                                >
                                                <span><label :for="category.id"></label></span>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="darea" role="alert">
                                    <div class="message" v-if="category.medias" >
                                        <img :src="'/storage/'+category.medias.path+'/'+category.medias.original_file_name" class="img-fluid d-block mx-auto" >
                                    </div>
