<template>
    <div>
        <div class="card card-border-color card-border-color-primary">
            <div class="card-header card-header-divider">Company Speciality</div>
            <div class="card-body">
                <form @submit.prevent="postSpeciality">
                    <div class="controls">
                        <div class="row">
                            <div class="col-md-12">
        ...
        methods:{
            ...
            postSpeciality(val){
                this.$validator.validateAll().then((result)=>{
                    if (result){
                        axios.post('/admin/company/speciality',{
                            name:this.name,
                            ...
                            val==='redirect'?this.$router.push({path:'/admin/company/speciality'}):''
                        }).catch(error=>{
                            let err
            ...
            saveAndClose(){
                let val='redirect';
                this.postSpeciality(val)
            },
            cancel(){
                this.$router.push({path:'/admin/company/speciality'})
            }
        }
    }
</script>
