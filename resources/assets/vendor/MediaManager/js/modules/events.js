...
// M O D A L
EventHub.listen('modal-details', () => {})
EventHub.listen('modal-hide', () => {})

// F I L E - L O A D I N G
EventHub.listen('loading-files-details', () => {
    setTimeout(() => {
...
// N O - F I L E S
EventHub.listen('no-files-details', () => {
...
// N O - S E A R C H
EventHub.listen('no-search-details', () => {
...
// A J A X  - E R R O R
EventHub.listen('ajax-error-details', () => {
