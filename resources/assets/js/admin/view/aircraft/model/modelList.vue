<template>
    <div class="card card-table">
        <data-table-join
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminAircraftModelCreate'"
                :tableHeadline="'Aircraft Models'"
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminAircraftModelShow', params:{id:props.data.id}}">
                        {{props.data.name}}
                    </router-link>
                </td>
                <td>
                ...
                <td>
                    <div class="adjustAction">
                        <router-link :to="{name:'adminAircraftModelEdit', params:{id:props.data.id}}" v-if="$root.$data.editPermission">
