<template>
    <div class="card card-table">
        <data-table
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminAircraftCategoryCreate'"
                :tableHeadline="'Aircraft Categories'"
                :searchField="'name'"
                :modelName="'category'"
                :typeName="'aircraft'"
                :ajax="{
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminAircraftCategoryShow', params:{id:props.data.id}}">
                        {{props.data.name}}
                    </router-link>
                </td>
                <td >
                ...
                <td>
                    <div class="adjustAction">
                        <router-link :to="{name:'adminAircraftCategoryEdit', params:{id:props.data.id}}" v-if="$root.$data.editPermission">
