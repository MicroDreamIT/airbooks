                ...
                <div class=" aside_bar" >
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            ...
                            <!--<a class="dropdown-item" @click="is_active = ! is_active" href="#">Is Active</a>-->
                        </div>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminEngineManufacturerCreate'}" v-if=" $root.$data.createPermission">
                            +Add
                        </router-link>
                ...
                <div class="listContent" ref="listHeight" :style="" v-if="manufacturers.length">
                    <ul class="list-group">
                        ...
                        <router-link v-for="manufacturer in manufacturers"
                                     ...
                                     :to="{name:'adminEngineManufacturerShow', params:{id:manufacturer.id}}"
            ...
            <div slot="asideMainContent">
                <div v-if="manufacturer.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        ...
                        <div v-if="manufacturer.id">
                            <router-link :to="{name:'adminEngineManufacturerEdit', params:{id:manufacturer.id}}">
