                    ...
                    <div class="wizard wizard-ux" id="wizard1">
                        <div class="steps-container">
                            <ul class="steps" style="margin-left: 0">
                                <li :class="stepOne" data-step="1">APU<span class="chevron"></span></li>
                        ...
                        <div class="step-content">
                                ...
                                <div class="container p-0">
                                    <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate=""  @submit.prevent="checkThisPage('form-1',2)" data-vv-scope="form-1">
                                        <div class="form-group row">
                                            <div class="col-sm-7">
                                                <h3 class="wizard-title">APU Info</h3>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        v-model="apu.category"
                                                        :options="$root.$data.apuCategories"
                                                        label="name"
                                                        name="category"
                                                        @input="apu.category.id!=apu.category_id?apu.manufacturer=null:null,$root.findManufacturers('apu', apu.category)"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        v-model="apu.manufacturer"
                                                        :options="$root.$data.apuManufacturers"
                                                        label="name"
                                                        name="manufacturer"
                                                        @input="apu.manufacturer.id!=apu.manufacturer_id?apu.type=null:null,$root.findType('apu', apu.manufacturer)"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="type"
                                                        @input="apu.type.id!=apu.type_id?apu.model=null:null,$root.findModel('apu', apu.type)"
                                        ...
                                        <hr>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-left text-sm-right">Serial Number </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input v-model="apu.serial_number" type="text" name="serial_number"
                                                       :class="{'form-control': true, 'is-danger': errors.has('form-1.serial_number') }"
                                                       data-error="name is required."
                                                       v-validate="'required'"
                                                >
                                                <div v-show="errors.has('form-1.serial_number')" class="help is-danger">
                                                    {{ errors.first('form-1.serial_number') }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-left text-sm-right">Part Number</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input v-model="apu.part_number" type="text" name="part_number"
                                        ...
                                        <div class="form-group row" v-for="(frm, index) in apu.custom">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <p><br>
                                                    ...
                                                    <template v-if="suggestModal">
                                                        <suggest-modal  @suggestModalData="suggestModal=false" :fieldtype="'apu'"></suggest-modal>
                                                    </template>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                <div  class="btn btn-secondary btn-space wizard-previous own-right" data-wizard="#wizard1" @click.prevent="$router.push({name:'userApuList'})">Cancel</div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div :class="'step-pane'+secondPageActive" data-step="2">
                                <div class="container p-0">
                                    <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" @submit.prevent="checkThisPage('form-2',3)" data-vv-scope="form-2">
                                        ...
                                        <div class="form-group row" v-if="apu.offer_for=='Sale'">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                ...
                                                >{{'USD '}}{{apu.price | currency('', 2, { symbolOnLeft: false, spaceBetweenAmountAndSymbol: true }) }}
                                                <div v-show="errors.has('form-2.price')" class="help is-danger">
                                                    {{ errors.first('form-2.price') }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row" v-if="apu.offer_for=='Lease'||apu.offer_for=='Lease Purchase'">
                                            <label class="col-12 col-sm-3 col-form-label text-left text-sm-right own-uppercase"> {{apu.offer_for}} Terms </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea class="form-control" v-model="apu.lease_terms" rows="2"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row" v-if="apu.offer_for=='Exchange'">
                                            <label class="col-12 col-sm-3 col-form-label text-left text-sm-right">Exchange Terms</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <textarea class="form-control" v-model="apu.exchange_terms" rows="2"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <date-picker v-model="apu.availability"
                                                             v-validate="'required'"
                                                             name="availability"
                                        ...
                                        <div class="form-group row" v-for="(frm, index) in apu.custom2">
                                    ...
                                    <form class="form-horizontal group-border-dashed" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="">
                                        <div class="form-group row mediaArea">
                                            <div class="col-sm-7">
                                                ...
                                                <br>
                                                <button class="btn btn-primary btn-space d-inline-block" @click.prevent="$root.showMedia=true"> <i class="fas fa-upload"></i> Select or Upload Images </button><br>
                                            </div>
                                            <div class="col-md-12">
                                                <hr>
                            ...
                            <div :class="'step-pane'+fourPageActive" data-step="4">
                                ...
                                <div class="row p-0">
                                    <div class="col-lg-9">
                                        <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" @submit.prevent="updateApu">
                                            <div class="form-group row">
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <textarea class="form-control" rows="6" v-model="apu.description"  placeholder="Additional details"></textarea><br>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-11 d-flex justify-content-end">
                                                    <div>
                                                        ...
                                                        <button class="btn btn-danger btn-space wizard-next" @click.prevent="$router.push({name:'userApuList'})">Cancel</button>
...
<script src="./js/apuEdit.js"></script>
