<template>
    <div>
        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
            <div class="row be-datatable-header card-header">
                <div class="col-md-12 d-flex justify-content-between" id="adjustHeader">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                       ...
                       <template v-if="addButton && $root.$data.createPermission ||userAddButton">
            ...
            <div class="row be-datatable-body" v-if="dataList.length && $root.$data.showPermission">
            ...
            <div class="row be-datatable-footer">
                <div class="col-sm-5 d-flex align-items-center flex-wrap" id="bottomAdjust">
                    ...
                    <div class="dataTables_info" id="table1_info" role="status" aria-live="polite" v-if="$root.$data.showPermission"> ( Showing {{from}} to
                        {{to}}
                        of {{total}} )
                    </div>
                </div>
