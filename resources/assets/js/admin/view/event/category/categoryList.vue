<template>
    <div class="card card-table">
        <data-table
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminEventCategoryCreate'"
                :tableHeadline="'Event Categories'"
                :searchField="'name'"
                :modelName="'event'"
                :ajax="{
                            url: url
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminEventCategoryShow', params:{id:props.data.id}}">
                        {{props.data.name}}
                    </router-link>
                </td>
                <td>
                ...
                <td>
                    <div class="adjustAction">
                        <router-link :to="{name:'adminEventCategoryEdit', params:{id:props.data.id}}" v-if="$root.$data.editPermission">
