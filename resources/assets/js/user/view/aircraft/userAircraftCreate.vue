<template>
    <div>
        <select-promote-modal
            :title="'Select aircraft promote mode'"
            :listRoute="'userAircrafts'"
            :redirectUrl="'userAircraftCreate'"
                    ...
                    <div class="wizard wizard-ux" id="wizard1">
                        ...
                        <div class="step-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        @input="aircraftModel=null, $root.findModel('aircraft', staticForm.aircraftType)"
                                                        v-validate="'required'"
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-12 col-sm-8 col-lg-6">
                                               <label class="custom-control custom-checkbox custom-control-inline">
                                                   <input class="custom-control-input" type="checkbox" @input="removeAllEngine()"><span class="custom-control-label custom-control-color">Airframe only</span>
                                               </label><br>
                                           </div>
                                       </div>
                            ...
                            <div :class="'step-pane'+fivePageActive" data-step="5">
	                            <div class="container p-0">
                                <form class="form-horizontal group-border-dashed" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" enctype="multipart/form-data">
                            ...
                            <div :class="'step-pane'+sixPageActive" data-step="6">
	                            <div class="row p-0">
                              <div class="col-lg-9">
                                  <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" enctype="multipart/form-data" @submit.prevent="postForm">
                                      <div class="form-group row">
                                          <div class="col-sm-7">
                                      ...
                                      <div class="form-group row">
                                          <div class="col-sm-11 d-flex justify-content-end">
                                              <div>
                                                  <div class="btn btn-secondary btn-space wizard-previous"
                                                       data-wizard="#wizard1"
                                                       @click.prevent="goPage(5)">Previous
                                                  </div>
                                                  ...
                                                  <button type="submit" class="btn btn-space btn-primary pl-4 pr-4"><i class="icon mdi mdi-refresh-sync"></i> Save & New</button>
                                              </div>
                                          </div>
                                      </div>
...
<script src="./js/userAircraftCreate.js"></script>
