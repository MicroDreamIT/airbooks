...
<script>
    export default {
        ...
        created(){
            axios.get('/admin/admin-user/'+this.$route.params.id+'/edit').then(response=>{
                this.permissions=response.data.permissions
                this.companies=response.data.companies
                this.adminUser=response.data.adminUser.contact
                this.adminUser.is_active=response.data.adminUser.is_active
                this.adminUser.permission=response.data.adminUserPermsions
            })
        },
        methods: {
            ...
            updateAdminUser(val) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        axios.patch('/admin/admin-user/'+this.$route.params.id, this.adminUser).then(response => {
