                    ...
                    <div class="wizard wizard-ux" id="wizard1">
                        ...
                        <div class="step-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="category"
                                                        @input="engine.category.id!=engine.category_id?engine.manufacturer=null:null,$root.findManufacturers('engine', engine.category)"
                                                        v-validate="'required'"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="manufacturer"
                                                        @input="engine.manufacturer.id!=engine.manufacturer_id?engine.type=null:null,$root.findType('engine', engine.manufacturer)"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="type"
                                                        @input="engine.type.id!=engine.type_id?engine.model=null:null,$root.findModel('engine', engine.type)"
                                ...
                                <div class="container p-0">
                                    <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" @submit.prevent="checkThisPage('form-2',3)" data-vv-scope="form-2">
                                        ...
                                        <div class="form-group row" v-if="engine.offer_for=='Lease'|| engine.offer_for=='Lease Purchase'">
                                            <label class="col-12 col-sm-3 col-form-label text-left text-sm-right"> {{engine.offer_for}} Terms </label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                            ...
                            <div :class="'step-pane'+fourPageActive" data-step="4">
                                ...
                                <div class="row p-0">
                                    <div class="col-lg-9">
                                        <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" @submit.prevent="updateEngine">
                                            <div class="form-group row">
                                                <div class="col-sm-7">
...
<script src="./js/engineEdit.js"></script>
