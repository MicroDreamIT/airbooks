                ...
                <div class=" aside_bar">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminApuManufacturerCreate'}" v-if=" $root.$data.createPermission">
                            +Add
                        </router-link>
                ...
                <div class="listContent" ref="listHeight" :style="" v-if="manufacturers.length">
                    <ul class="list-group">
                        ...
                        <router-link v-for="manufacturer in manufacturers"
                                     ...
                                     :to="{name:'adminApuManufacturerShow', params:{id:manufacturer.id}}"
            ...
            <div slot="asideMainContent">
                <div v-if="manufacturer.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        ...
                        <div v-if="manufacturer.id">
                            <router-link :to="{name:'adminApuManufacturerEdit', params:{id:manufacturer.id}}">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="cat_desc" v-if="manufacturer.country">
                                            ...
                                            <strong> {{manufacturer.country.name}}</strong>
                                        </p>
