...
Webflow.require('ix').init([
  {"slug":"close-cookies-alert","name":"Close Cookies Alert","value":{"style":{},"triggers":[{"type":"click","selector":".cookies-alert-section","preserve3d":true,"stepsA":[{"opacity":0,"transition":"transform 200 ease 0, opacity 200 ease 0","x":"0px","y":"100px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"show-cookies-section","name":"Show Cookies Section","value":{"style":{"opacity":0,"x":"0px","y":"100px","z":"0px"},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"transform 200 ease 0, opacity 200 ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"show-float-search","name":"Show Float Search","value":{"style":{},"triggers":[{"type":"scroll","selector":".float-search-section","preserve3d":true,"stepsA":[{"display":"block","opacity":0,"transition":"opacity 500ms ease 0, transform 300ms ease 0, width 200 ease 0","x":"0px","y":"-64px","z":"0px"}],"stepsB":[{"display":"block","opacity":1,"transition":"opacity 300ms ease 0, transform 500ms ease 0","x":"0px","y":"0px","z":"0px"}]}]}},
  {"slug":"scroll-search-initial-view","name":"Scroll Search Initial View","value":{"style":{"display":"none","opacity":0,"x":"0px","y":"-64px","z":"0px"},"triggers":[]}},
  {"slug":"rotate","name":"Rotate","value":{"style":{},"triggers":[{"type":"load","preload":true,"loopA":true,"stepsA":[{"transition":"transform 3000ms linear 0","rotateX":"0deg","rotateY":"0deg","rotateZ":"359deg"},{"rotateX":"0deg","rotateY":"0deg","rotateZ":"0deg"}],"stepsB":[]}]}},
  {"slug":"show-filter","name":"Show Filter","value":{"style":{},"triggers":[{"type":"click","selector":".filter-wrapper","stepsA":[{"display":"block","opacity":1,"transition":"transform 200 ease 0, opacity 200 ease 0"}],"stepsB":[]}]}},
  {"slug":"close-filter","name":"Close Filter","value":{"style":{},"triggers":[{"type":"click","selector":".filter-wrapper","stepsA":[{"display":"none","opacity":0,"transition":"opacity 200 ease 0"}],"stepsB":[]}]}}
]);
