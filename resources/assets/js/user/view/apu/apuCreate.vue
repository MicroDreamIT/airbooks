<template>
    <div>
        <select-promote-modal
                :title="'Select APU promote mode'"
                :listRoute="'userApuList'"
                :redirectUrl="'userApuCreate'"
                    ...
                    <div class="wizard wizard-ux" id="wizard1">
                        ...
                        <div class="step-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="category"
                                                        @input="apu.manufacturer=null, $root.findManufacturers('apu', apu.category)"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="manufacturer"
                                                        @input="apu.type=null, $root.findType('apu', apu.manufacturer)"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="name"
                                                        name="type"
                                                        @input="apu.model=null, $root.findModel('apu', apu.type)"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <v-select
                                                        ...
                                                        label="first_name"                                      :options="this.$root.$data.contacts"
                            ...
                            <div :class="'step-pane'+fourPageActive" data-step="4">
                                ...
                                <div class="row p-0">
                                    <div class="col-lg-9">
                                        <form class="form-horizontal group-border-dashed" action="#" data-parsley-namespace="data-parsley-" data-parsley-validate="" novalidate="" @submit.prevent="postApu">
                                            <div class="form-group row">
                                                <div class="col-sm-7">
...
<script src="./js/apuCreate.js"></script>
