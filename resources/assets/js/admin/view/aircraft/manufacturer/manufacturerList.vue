<template>
    <div class="card card-table">
        <data-table-join
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminAircraftManufacturerCreate'"
                :tableHeadline="'Aircraft Manufacturers'"
            ...
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <div class="adjustAction">
                        <router-link :to="{name:'adminAircraftManufacturerEdit', params:{id:props.data.id}}" v-if="$root.$data.editPermission">
...
<script>
    export default {
        ...
        data() {
            return {
                status: null,
                url: '/manufacturer?type=aircraft',
                columns: [
                    {name: 'Name'},
