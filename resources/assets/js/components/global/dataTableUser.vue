    ...
    <div>
        <div class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
            <div class="row be-datatable-header card-header">
                <div id="adjustHeader" class="col-md-12 d-flex justify-content-between" >
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="d-flex align-items-center justify-content-start">
                                <div v-if="this.dropDownSearch.length>0" class="selectedArea">
                                    <div v-for="(dropdown, index) in dropDownSearch" class="d-flex justify-content-center align-items-center">
                                        <label class="control-label" style="width: 72px;    text-transform: capitalize;    padding-top: 4px;">{{dropdown.label}}</label>
                        ...
                        <template v-if="addButton">
                            <router-link :to="{name:addLink}"
                                         class="btn btn-primary  pt-1 pb-1 pl-5 pr-5 mr-2">
                                <i class="icon mdi mdi-plus pr-1"></i> Add </router-link>
                        </template>

                        <div class="btn-group" v-if="$route.path=='/user/parts'">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <form id="importForm" method="post"
                                      class="d-none"
                                      :action="'/user/import/data/part'" enctype="multipart/form-data" >
