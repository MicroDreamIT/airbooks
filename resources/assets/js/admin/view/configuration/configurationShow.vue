    ...
    <div>
        ...
        <admin-aside>
            ...
            <div slot="asideContent">
                <div class="aside_bar" >
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <router-link class="btn btn-primary mr-1"
                                     :to="{name:'adminConfigurationCreate'}">
                            +Add
                        </router-link>
                ...
                <div class="listContent" ref="listHeight" :style="" v-if="configurations.length">
                    <ul class="list-group">
                        <router-link v-for="configuration in configurations"
                                     class="list-group-item" :key="configuration.id"
                                     :to="{name:'adminConfigurationShow', params:{id:configuration.id}}"
                                     @click.native="show(configuration.id)"
                                     tag="li"
            ...
            <div slot="asideMainContent">
                <div v-if="configuration.id">
                    <div class="card-header d-flex justify-content-between flex-wrap">
                        <span>{{configuration.name}}</span>
                        <div v-if="configuration.id">
                            <router-link :to="{name:'adminConfigurationEdit', params:{id:configuration.id}}">
                                <i class="mdi mdi-edit"></i>
                            </router-link>
                            <a href="" class="pl-2 default-color" @click.prevent="deleteMe(configuration.id)">
                    ...
                    <div class="card-body  card-header-contrast">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        <p class="cat_desc" v-if="configuration.name">
                                            <span>Name  </span> <br>
                                            <strong>{{configuration.name}}</strong>
                                        </p>
                                        <p class="cat_desc" v-if="configuration.created_at">
                                            <span>Date Created </span> <br>
                                            <strong>{{$root.parseDate(configuration.created_at)}}</strong>
                                        </p>
                                        <p class="cat_desc" v-if="configuration.updated_at">
                                            <span>Date Modified </span> <br>
                                            <strong>{{$root.parseDate(configuration.updated_at)}}</strong>
                                        </p>
                                        ...
                                        <div class="cat_desc">
                                            ...
                                            <div class="switch-button switch-button-success switch-button-xs activeSwitch" >
                                                <input
                                                        ...
                                                        name="swt1"
                                                        :id="configuration.id"
                                                        @click.prevent="$root.changeIsBooleanStatus(configuration, 'is_active', 'App-Configuration')"
                                                >
                                                <span><label :for="configuration.id"></label></span>
                                            </div>
                                        </div>
                            ...
                            <!--<div class="message">-->
                            <!--<img src="https://avatars1.githubusercontent.com/u/8063392?s=460&v=4" class="img-fluid d-block mx-auto" >-->
                            <!--</div>-->
                            <!--</div>-->
...
<script>
    export default {
        ...
        methods:{
            ...
            show(id){
                axios.get('/admin/configuration/'+id,{
            ...
            deleteMe(id){
                this.$root.confirmationDelete().then(val => {
                    if (val) {
                        axios.delete('/admin/configuration/' + id).then(response => {
