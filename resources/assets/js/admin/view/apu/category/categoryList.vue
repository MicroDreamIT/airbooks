<template>
    <div class="card card-table">
        <data-table
                ...
                :search="true"
                :columns="columns"
                :addLink="'adminApuCategoryCreate'"
                :tableHeadline="'APU Categories'"
                :searchField="'name'"
                :modelName="'category'"
                :typeName="'apu'"
                :ajax="{
        ...
        >
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <router-link :to="{name:'adminApuCategoryShow', params:{id:props.data.id}}">
                        {{props.data.name}}
                    </router-link>
                </td>
                <td>
                ...
                <td>
                  <div class="adjustAction">
                      <router-link :to="{name:'adminApuCategoryEdit', params:{id:props.data.id}}" v-if="$root.$data.editPermission">
